...
<ul>
	...
	<li><code>divide</code> -&nbsp;This method divides the <code>result</code> by the given number <code>value</code> and returns the updated <code>Calculator</code>. If the passed value is <code>0</code>, an error <merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>"Division by zero is not allowed"</code> should be thrown.</li>
...
<ul>
	...
	<li><merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>2 &lt;= actions.length &lt;= 2 * 10<sup>4</sup></code></li>
	<li><merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>1 &lt;= values.length &lt;= 2 * 10<sup>4</sup>&nbsp;- 1</code></li>
