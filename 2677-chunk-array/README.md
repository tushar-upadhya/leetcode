...
<ul>
	...
	<li><merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>2 &lt;= JSON.stringify(arr).length &lt;= 10<sup>5</sup></code></li>
	<li><merlin-component id="merlin-code-summarizer" class="merlin-code-summarizer"></merlin-component><code>1 &lt;= size &lt;= arr.length + 1</code></li>
</ul>
</div>